...
local function radish()
	...
	inst.components.inventoryitem.imagename = "kyno_radish"

	inst:AddComponent("cookable")
	inst.components.cookable.product = "kyno_radish_cooked"
...
local function radish_cooked()
	...
	inst:AddComponent("inventoryitem")
	inst.components.inventoryitem.atlasname = "images/inventoryimages/kyno_foodimages.xml"
	inst.components.inventoryitem.imagename = "kyno_radish_cooked"
...
local function radish_seeds()
	...
	inst:AddComponent("inventoryitem")
	inst.components.inventoryitem.atlasname = "images/inventoryimages/kyno_foodimages.xml"
	inst.components.inventoryitem.imagename = "kyno_radish_seeds"
	...
	inst.components.plantable.product = "kyno_radish"
...
Prefab("kyno_radish", radish, assets, prefabs),
Prefab("kyno_radish_cooked", radish_cooked, assets, prefabs),
Prefab("kyno_radish_seeds", radish_seeds, assets, prefabs)